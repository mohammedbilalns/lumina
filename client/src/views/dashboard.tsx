...
const ARTICLES = [
  ...
  },
  {
    ...
    excerpt:
      'Why we love dark interfaces and how they affect our cognitive load and visual perception.',
        ...
        <main className="w-full max-w-4xl">
          ...
          <div className="space-y-8">
            {ARTICLES.map((article) => (
              <article
                key={article.id}
                className="group relative bg-slate-900/40 backdrop-blur-sm border border-white/5 rounded-2xl p-4 sm:p-6 hover:border-white/10 hover:bg-slate-900/60 transition-all flex flex-col-reverse sm:flex-row gap-6"
              >
